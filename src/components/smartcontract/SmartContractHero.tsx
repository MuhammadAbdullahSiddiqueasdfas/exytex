...
export const SmartContractHero: React.FC = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const navigate = useNavigate();
  
  const heading = useTypewriter({ text: 'Blockchain Smart Contract Development', speed: 50 });
  const subtitle = useTypewriter({ 
    text: 'Build trusted digital agreements with advanced smart contract services', 
    speed: 30,
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-slate-950 pt-20" style={{ fontFamily: "'Inter', 'Space Grotesk', sans-serif" }}>
      {/* Background Pattern */}
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="text-left">
            ...
            >
              As a leading Blockchain development company, we help firms automate, validate, and secure 
              peer-to-peer transactions over public and private networks with enterprise-grade smart contracts.
            </motion.p>
