...
const models = [
  { icon: DollarSign, title: 'Fixed Price Model', description: 'Best for small-medium apps, pay fixed milestones', details: 'Ideal for well-defined projects with clear scope and requirements' },
  { icon: Clock, title: 'Time & Material Model', description: 'Flexible scope, billed per effort, ideal for dynamic projects', details: 'Perfect for evolving requirements and agile development' },
  { icon: Target, title: 'SLA/Milestone-Based Model', description: 'Iterative projects with defined internal/external milestones', details: 'Structured approach with regular deliverables and reviews' },
  { icon: Users, title: 'Build Your Team® Model', description: 'Access world-class developers on-demand for your project needs', details: 'Scale your team up or down based on project requirements' },
];

const AndroidEngagementSection: React.FC = () => {
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="text-white/90 text-sm">{model.details}</p>
                </div>
              </motion.div>
            </motion.div>
          ))}
...
export default AndroidEngagementSection;
