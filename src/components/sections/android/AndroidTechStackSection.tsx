...
const techStack = {
  'Programming Languages': ['Java', 'Kotlin', 'C/C++', 'C#', 'Lua'],
  'Development Tools': ['Android Studio', 'Fabric', 'FlowUP', 'Instabug'],
  'Cross-platform Tools': ['React Native', 'Xamarin', 'Flutter', 'PhoneGap'],
  'Frameworks': ['Corona SDK', 'Ionic', 'Titanium', 'Sencha'],
  'Native Libraries': ['OpenGL ES', 'Media Framework', 'Webkit'],
  'Related Tech': ['Material Design', 'MVVM', 'LiveData', 'Dagger2', 'Nevercode', 'Bugsnag'],
};

const AndroidTechStackSection: React.FC = () => {
