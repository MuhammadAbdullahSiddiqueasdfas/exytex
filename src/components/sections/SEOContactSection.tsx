...
export const SEOContactSection: React.FC = () => {
  ...
  return (
    <section id="seo-contact" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto font-light" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, sans-serif' }}>
            Let's discuss how we can help improve your search rankings and drive more organic traffic to your website
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-white rounded-xl p-6 sm:p-8 shadow-xl border border-blue-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+923001234567" className="text-gray-600 hover:text-blue-600 transition-colors text-sm sm:text-base font-light" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, sans-serif' }}>
                      +92 300 1234567
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl p-6 sm:p-8 text-white shadow-xl">
            ...
            <div className="bg-white rounded-xl p-6 sm:p-8 shadow-xl border border-blue-100">
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    <label htmlFor="website" className="block text-sm font-semibold text-gray-900 mb-2" style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}>
                      Website URL
                    </label>
                    <input
                      type="url"
