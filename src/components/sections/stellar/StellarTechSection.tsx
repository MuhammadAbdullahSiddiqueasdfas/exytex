...
const techCategories = [
  {
    ...
    items: ['Ledger Nano S', 'Keybase', 'Solar Wallet', 'Lobstr', 'StellarX', 'Stellarport', 'Stellarterm', 'Kelp'],
    color: '#6C63FF',
  },
  {
    icon: Server,
...
const StellarTechSection: React.FC = () => {
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 text-xl max-w-3xl mx-auto">
            Cutting-edge tools and technologies for stellar blockchain development
          </p>
        </motion.div>
          ...
          <div className="relative w-full max-w-6xl">
            {techCategories.map((category, index) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className="w-80 h-96 rounded-2xl p-8 bg-gradient-to-br from-[#001F54]/90 to-[#1a1a3e]/90 backdrop-blur-sm border border-[#6C63FF]/30"
...
export default StellarTechSection;
