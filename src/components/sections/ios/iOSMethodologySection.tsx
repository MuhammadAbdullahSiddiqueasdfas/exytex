...
import { FileText, Search, Palette, TestTube, Headphones } from 'lucide-react';

const steps = [
  { icon: FileText, title: 'Agreement on Service Models', description: 'Choose engagement & allocate resources' },
  { icon: Search, title: 'Assessment of Requirements', description: 'Gather goals & define roadmap' },
  { icon: Palette, title: 'Design & Development', description: 'Agile, incremental delivery' },
  { icon: TestTube, title: 'Testing & QA', description: 'Rigorous testing with client feedback' },
  { icon: Headphones, title: 'Support & Maintenance', description: 'Post-deployment monitoring & debugging' },
];

const iOSMethodologySection: React.FC = () => {
...
export default iOSMethodologySection;
